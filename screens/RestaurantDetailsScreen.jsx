...
const RestaurantDetailsScreen = ({ route }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ padding: 12, marginTop: 18, marginLeft: 20, marginRight: 20, flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderRadius: 5, borderWidth: 4, borderColor: "#6CAB3C" }}>
